...
describe("ponds-forge/TimetableParser", () => {
    ...
    it("timetableFromHTML", () => {
        ...
        expect(item0.startTime).to.equal("5:30 am");
        expect(item0.endTime).to.equal("11:25 am");
        ...
        expect(item1.startTime).to.equal("6:30 am");
        expect(item1.endTime).to.equal("4:00 pm");
